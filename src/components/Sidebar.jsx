          ...
          <DropdownMenu isOpen={showSalesDropdown}>
            ...
            <SubMenuItem>
              <StyledNavLink to="/SalesReport/DailyStats">
                ...
                >
                  <path
                    d="M5 9.2H7V19H9.2V5.8H11.2V19H13.4V9.8H15.4V19H17.6V2H19.6V19H22V21H3V19H5V9.2Z"
                    fill="currentColor"
                  />
                </svg>
                일별 매출 통계
