...
const CalendarPage = () => {
  ...
  if (loading) return <CalendarContainer>로딩중...</CalendarContainer>;
  if (error) return <CalendarContainer>에러 발생: {error.message}</CalendarContainer>;
...
const CalendarTable = styled.table`
    ...
    /* 달력 전체 크기 조정 */
    transform: scale(0.90);  // 85% 크기로 축소
    transform-origin: center;  // 왼쪽 위 기준으로 축소
`;
